...
This sketch demonstrates the use of the Adafruit Motorshield and
two motors mounted on a simple robot. The robot follows a course through
a series of motor commands placed in the setup() routine . 
These execute once. 
