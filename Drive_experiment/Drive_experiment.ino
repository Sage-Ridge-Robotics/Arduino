...
const int motorInterval = 10000;    // Sets length of time a motor command
...
const int numCommands = 2;         // The number of motor commands given below. This must be
...
{ 
  ...
  myServo0.attach(9);
  AFMS.begin();
  myDCMotor01->setSpeed(50);
  myDCMotor02->setSpeed(50);
} 
