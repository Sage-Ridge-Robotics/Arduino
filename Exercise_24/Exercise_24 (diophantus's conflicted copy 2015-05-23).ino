...
This sketcy is modified from an Adafruit example and
...
void loop(){
  ...
  if (millis() - timer > 5000) { 
   ...
   // Distance to target cache
     ...
     Serial.print("Forward azimuth: "); Serial.print(t_distance); Serial.println(" degrees east or west of true north");
